...
func main() {
	...
	req := omniwriter.TransformRequest{
		...
		TargetFormat: omniwriter.FormatText,
		Mapping:      schema,
		Input:        input,
	}
	...
	fmt.Println("JSON → Text Transformation")
	fmt.Println("===========================")
	...
	if err := os.WriteFile("output.txt", result.Output, 0644); err != nil {
